...
import { LayoutDashboard, MessageCircle, Cpu, Radio, BrainCircuit, Settings, Moon, Sun, RefreshCw, LogOut, UserRound } from '@lucide/vue'
...
<template>
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <div class="sidebar-account"><UserRound :size="17"/><div><strong>{{ auth.user?.username }}</strong><small>管理员</small></div></div>
    ...
    <main class="main-area">
      <header class="topbar">
        ...
        <div class="top-actions">
          ...
          <button class="icon-btn danger" @click="logout" aria-label="退出登录"><LogOut :size="18"/></button>
        </div>
      </header>
